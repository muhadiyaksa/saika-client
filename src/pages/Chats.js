          ...
          <>
            {isSisaAnggota === false ? (
              ...
              <>
                {isNotAnggota === true ? (
                  <div className="sorry mx-auto text-center pt-5">
                    <img src={Disconnected} alt="Icon Disconnected" />
                    <p className="mt-4">
                      Ups Masalah Jaringan, Kamu keluar dari room <br />
                      Join lagi kuy. . .
                    </p>
                    <Button isPrimary onClick={joinRoom} className="text-decoration-none text-white w-auto">
                      Join Kembali
                    </Button>
                    <Button type="link" href="/find" className="text-secondary mt-4 d-block" style={{ fontSize: "12px" }}>
                      Keluar
                    </Button>
                  </div>
                ) : (
