        ...
        <div className="col-md p-3">
          ...
          <div className="row mt-3">
            ...
            <div className="col-md">
              ...
              {dataDetail?.benefits?.split(",").length < 2 ? (
                <p>{dataDetail?.benefits}</p>
              ) : (
                <ul className="list-group px-3 text-softwhite">
          ...
          <div className="row mt-3">
            <div className="col-md">
              ...
              <p>
                {changeDateFormat(dataDetail?.eventDate)} <span className={`${dataDetail?.eventDateEnd ? "" : "d-none"}`}>- {dataDetail?.eventDateEnd}</span>
              </p>
            </div>
            <div className="col-md">
              <p className="fw-bold mb-0 pb-0">Waktu Pelaksanaan</p>
              {dataDetail?.eventTimeStart ? (
                <p>
                  {dataDetail?.eventTimeStart} WIB
                  <span className={`${dataDetail?.eventTimeFinish ? "" : "d-none"}`}>- {dataDetail?.eventTimeFinish} WIB</span>
                </p>
              ) : (
                <p>Tidak Tersedia</p>
              )}
          ...
          <div className="row mt-3">
            <div className="col-md">
              ...
              <p>
                <span className="text-capitalize">{dataDetail?.paymentType}</span> <br />
            ...
            <div className="col-md">
              ...
              <p>
                <Button isSecondary type="link" isExternal href={dataDetail?.registrationLink} className="d-inline-block  text-white">
                  <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" className="bi bi-link-45deg me-2" viewBox="0 0 16 16">
          ...
          <div className="row mt-3">
            <div className="col-md">
              ...
              <p className="mb-1 text-capitalize">{dataDetail?.occurenceType !== "online" ? dataDetail?.occurenceType : ""}</p>
              {dataDetail?.occurenceType === "online" ? (
                <>
                  <div className="image">
                    <img width="30" height="30" className="me-2 " src={`${dataDetail?.mediaMeet === "zoom" ? "/image/zoom_icon.png" : "/image/gmeet_icon.png"}`} alt="" />
              ...
              <div className="social d-flex align-items-center">
                {dataDetail?.instagram !== "" ? (
                  <Button type="link" href={dataDetail?.instagram} isExternal className="me-2 mt-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-instagram text-cream" viewBox="0 0 16 16">
                ...
                {dataDetail?.facebook !== "" ? (
                  <Button type="link" href={dataDetail?.facebook} isExternal className="me-2 mt-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-facebook text-cream" viewBox="0 0 16 16">
                ...
                {dataDetail?.twitter !== "" ? (
                  <Button type="link" href={dataDetail?.twitter} isExternal className="me-2 mt-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-twitter text-cream" viewBox="0 0 16 16">
