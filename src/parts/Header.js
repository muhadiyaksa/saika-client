...
export default function Header() {
          ...
          <div className="hover-item text-start ">
            <ul className="list-group  ">
              ...
              <li className="list-group-item">
                <Button className="btn d-inline-flex w-100 align-items-center shadow-none" onClick={handleShowNotif}>
                ...
                <Button className="btn d-inline-flex w-100 align-items-center shadow-none" onClick={handleShowNotif2}>
  ...
  return (
    <nav className="navbar navbar-expand-sm">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mx-auto mb-lg-0 flex-sm-row  d-flex ">
            <li className="nav-item ">
              <Button type="link" className={`nav-link text-white   shadow-none ${getNavLinkClass("/find")}`} aria-current="page" href="/find">
                Pesan
              </Button>
            </li>
            <li className="nav-item">
              <Button type="link" className={`nav-link text-white  shadow-none  ${getNavLinkClass("/search")}`} href="/search">
                Acara
              </Button>
            </li>
            <li className="nav-item">
              <Button type="link" className={`nav-link text-white   shadow-none ${getNavLinkClass("/chat")}`} href="/chat">
                Teman
              </Button>
            </li>
          </ul>
      ...
      <ModalElement isHeader={true} show={show} isCentered={true} funcModal={handleCloseNotif} heading={"Ubah Profile"}>
        <div className="image-profile">
          <div className="image">
            <img src={dataUser.fotoUser ? `${dataUser.fotoUser.fotoUrl === "" ? avaUser : dataUser.fotoUser.fotoUrl}` : `${avaUser}`} alt="User" />
          </div>
          <input type="file" className="d-none" ref={refInputFile} />
          <Button className="btn  shadow-none " onClick={() => refInputFile.current.click()}>
